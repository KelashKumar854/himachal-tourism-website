      ...
      <div className='packages-main'>
        <div className='packages-container'>
            <div className='packages-heading'>
                ...
                <p>Book Instantly and avail special discount in all packages shown below.</p>
            </div>
                    ...
                    <div key={index} className='package-data-container'>
                        ...
                        <div className='package-detail'>
                            ...
                            <ul className='package-time'>
                                <li><FaBed  color='#02ad88' className='package-time-logo'/>{packages.nights}</li>
                                <li><FaBath  color='#02ad88' className='package-time-logo'/>{packages.days}</li>
                                <li><FaShareSquare  color='#02ad88' className='package-time-logo'/>{packages.person}</li>
                            </ul>
                            <button className='package-btns'>Enquiry Now</button>
                            <button className='package-btns'>View Details</button>
                        </div>
                    </div>
                ))}
            </div>
